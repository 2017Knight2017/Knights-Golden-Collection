...
positions = {  
    ...
    "около западного японского сада": (5768, 3583),   
    "в западном японском саду": (6179, 3587),  
    "около восточного японского сада": (3473, 3525),    
    "в восточном японском саду": (3035, 3596),   
    ...
    "в кабинете социологии": (8972, 5328),  
    ...
    "около кабинета социологии": (8710, 5348), 
    ...
    "около клуба садоводства": (7268, 811),    
    "около класса 1-1": (8417, 818),  
    "около класса 1-2": (7271, 3871),   
    "около класса 2-1": (8367, 3863),    
    "около класса 2-2": (802, 826),   
    "около класса 3-1": (1945, 824), 
    "около класса 3-2": (8712, 310), 
    "около западных туалетов на 1 этаже": (6968, 299),   
    "около восточных туалетов на 1 этаже": (6963, 3398),  
    "около западных туалетов на 2 этаже": (8708, 3395), 
    "около восточных туалетов на 2 этаже": (500, 310),  
    "около западных туалетов на 3 этаже": (2244, 316),  
    "около восточных туалетов на 3 этаже": (6693, 205),    
    "в западном мужском туалете на 1 этаже": (8980, 209),  
    "в восточном мужском туалете на 1 этаже": (6692, 3270),   
    "в западном мужском туалете на 2 этаже": (8979, 3266),    
    "в восточном мужском туалете на 2 этаже": (227, 217),   
    "в западном мужском туалете на 3 этаже": (2512, 221), 
    "в восточном мужском туалете на 3 этаже": (6693, 471), 
    "в западном женском туалете на 1 этаже": (8979, 470), 
    "в восточном женском туалете на 1 этаже": (6693, 3532),    
    "в западном женском туалете на 2 этаже": (8980, 3528),   
    "в восточном женском туалете на 2 этаже": (228, 480),    
    "в западном женском туалете на 3 этаже": (2514, 474),    
    "в восточном женском туалете на 3 этаже": (5116, 4153),  
    "в женской душевой": (4105, 4147),  
    "в мужской душевой": (7836, 3638),   
    "в внутреннем кафетерии": (3704, 2378)
}
...
with open("output.json", "w") as output: 
    ...
    for place in places:
        ...
        p = chain(*[[time, *people] for time, people in markers[place].items()])
